...
def detect_blueprint_elements(image_path):
    """
    Detect blueprint elements and output JSON in the specified structure.
    """
    # Load the image
    ...
    if lines is not None:
        ...
        for i, wall1 in enumerate(potential_walls):
            ...
            for j in range(i + 1, len(potential_walls)):
                ...
                angle2 = np.arctan2(y2_2 - y1_2, x2_2 - y2_2)
...
if __name__ == "__main__":
    image_path = "/Users/imashiariyasinghe/Documents/GitHub/3Dimension/OPENCV/Photos/bp8.png"  # Example path for testing - you can change it
